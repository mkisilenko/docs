...
This is the "Brain" you speak to (RawBot/Groopy). It leverages advanced LLMs (like GPT-4o or Claude 3.5 Sonnet) to perform Natural Language Processing on your WhatsApp messages. 
